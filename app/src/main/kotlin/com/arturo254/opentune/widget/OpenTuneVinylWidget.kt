...
class OpenTuneVinylWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget = OpenTuneVinylWidget()
}

class OpenTuneVinylWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        ...
        provideContent {
            ...
            GlanceTheme(colors = OpenTuneWidgetColors) {
                VinylWidgetContent(state = state, uiPrefs = uiPrefs)
            }
        }
    }
}
...
private fun VinylWidgetContent(state: PlayerWidgetState, uiPrefs: WidgetUiPrefs) {
    ...
    Box(
        ...
        Box(
            modifier = GlanceModifier
                .fillMaxSize()
                .background(ColorProvider(Color.Black.copy(alpha = uiPrefs.scrimOpacity.coerceAtLeast(0.4f)))),
        ) {}
